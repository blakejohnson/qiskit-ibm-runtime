        ...
        for endpoint in endpoints:
            ...
            for program in endpoint['programs']:
                ...
                with open(f"programs/{program}.json", 'r') as f:
                    metadata = f.read()
                make_request(program_url, requests.patch, headers=headers.copy(), json=json.loads(metadata))
                ...
                make_request(program_url+'/data', requests.put, headers=headers.copy(), data=program_text)
